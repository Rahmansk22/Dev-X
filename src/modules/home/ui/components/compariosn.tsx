...
const ComparisonFeature: React.FC = () => {
  ...
  return (
    <section className="px-4">
      ...
      <div className="absolute inset-0 bg-linear-to-br from-primary/2 via-transparent to-primary/1 pointer-events-none" />
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-4">
          ...
          <p className="text-foreground/70 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed">
            For people, who are tired of those same blue-violet AI generated websites that can be smelled by miles away&hellip;.
          </p>
        </div>
